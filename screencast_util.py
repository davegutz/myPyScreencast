#  Utilities for myPyScreencast
#  2023-Oct-23  Dave Gutz   Create
...
def configurator(filepath):
    ...
    config_file_path = os.path.join(config_path, 'screencast.pref')
...
def load_config(path):
    ...
    if os.path.isfile(path):
        ...
        config.add_section('Screencast Preferences')
        config.set('Screencast Preferences', 'model remark',
                   'Possible values: tiny.en, base.en, small.en, medium.en, large')
        config.set('Screencast Preferences', 'model', 'small.en')
