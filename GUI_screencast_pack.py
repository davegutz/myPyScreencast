...
if __name__ == '__main__':
    ...
    action_label.pack(side="left", fill='x')
    ...
    raw_file_path_label.pack(side="left", fill='x')
    ...
    tuner_window_butt.pack(side="left", fill='x')
