...
# ffmpeg -f libxcb -video_size 1530x900 -framerate 30 -i :0.0+0,0 -vf format=yuv420p output.mp4
# full screen
# xdpyinfo | grep 'dimensions:'
# ffmpeg -f libxcb -video_size 1600x900 -framerate 30 -i :0.0+0,0 -vf format=yuv420p output.mp4
# full screen with sound; huge and stuttery
# ffmpeg -video_size 1600x900 -framerate 30 -f libxcb -i :0.0+0,0 -f pulse -i default -c:v libx264rgb -crf 0 -preset ultrafast -y sample.mkv
#    - add threads for stutter...none of these help
# ffmpeg -video_size 1600x900 -framerate 30 -threads 4 -f libxcb -i :0.0+0,0 -f pulse -i default -c:v libx264rgb -crf 0 -preset ultrafast -y sample.mkv
# ffmpeg -video_size 1600x900 -framerate 30 -threads 4 -f libxcb -i :0.0+0,0 -f pulse -i default -c:v libx265 -crf 28 -preset ultrafast -y sample.mkv
# ffmpeg -video_size 1600x900 -framerate 30 -threads 4 -f libxcb -i :0.0+0,0 -f pulse -i default -c:v libx265 -crf 28 -y sample.mkv
# ffmpeg -video_size 1600x900 -framerate 30 -threads 4 -f libxcb -i :0.0+0,0 -f pulse -i default -vcodec libx265 -crf 28 -y sample.mkv
# hardware accel doesn't help stutter
# ffmpeg -video_size 1600x900 -framerate 30 -threads 4 -f libxcb  -hwaccel vaapi -i :0.0+0,0 -f pulse -i default -vcodec libx265 -crf 28 -y sample.mkv
# ffmpeg -video_size 1600x900 -framerate 30 -threads 4 -f libxcb -i :0.0+0,0 -f pulse -i default -vcodec libx265 -crf 28 -y sample.mkv
