...
# Set to skip commericals (mark as chapters) or cut commericals dag 9/1/2025
# __command="comskip"
__command="./comcut"

# dag 9/1/2025
__container=comskip ./jellyfin-drv-comskip.sh
...
#comcut/comskip - currently using jellyfin ffmpeg in docker dag 9/1/2025
$__command --ffmpeg=$__ffmpeg --comskip=/usr/bin/comskip --lockfile=/tmp/comchap.lock --comskip-ini=/home/daveg/Documents/GitHub/jellyfin-dvr-comskip/config/comskip/comskip.ini "${__file}"
